<?php
// server/api/php/restoreProduct.php
// เปลี่ยนสถานะสินค้ากลับเป็น pending (รอตรวจสอบ)
...
if ($post->post_author != $user_id) {
    ...
    echo json_encode(['error' => 'You do not have permission to restore this product']);
    exit();
}

// เปลี่ยนสถานะกลับเป็น pending (รอตรวจสอบ)
