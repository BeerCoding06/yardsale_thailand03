...
// ดึง stock_quantity / stock_status ล่าสุดจาก WooCommerce REST + ปลั๊กอิน Yardsale (reserved / subtract_paid)
...
/**
 * คืนสต็อกล่าสุดต่อบรรทัด (สำหรับ refresh ตะกร้า / ตรวจ checkout)
 */
