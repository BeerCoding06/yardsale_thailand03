    ...
    <div class="flex flex-wrap justify-center max-w-screen-2xl m-auto">
      ...
      >
        <div
          ...
          :key="product?.databaseId || product?.id || Math.random()"
        ...
        >
            ...
            >
              <div class="grid gap-0.5 text-white">
                <ProductPrice
                  ...
                  variant="card"
                />
                <div class="font-bold">{{ product?.name || "Product" }}</div>
                <div
          ...
          <button
            ...
            @click="removeFromList(product?.databaseId || product?.id)"
          >
            <div
              class="w-12 h-12 rounded-full flex justify-center items-center bg-alizarin-crimson-950/90 shadow-md"
            >
              <UIcon
                name="i-iconamoon-heart-fill"
                size="26"
                class="text-alizarin-crimson-500 group-hover:text-white transition pulse-heart"
              />
            </div>
          </button>
        </div>
