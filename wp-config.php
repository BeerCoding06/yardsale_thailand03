 ...
 * * ABSPATH
 *
 * @link https://developer.wordpress.org/advanced-administration/wp-config/
 *
 * @package WordPress
 */
 ...
 *
 * @link https://developer.wordpress.org/advanced-administration/wp-config/#table-prefix
 */
$table_prefix = 'wp_';
...
if (!$wp_home) {
    ...
    if (isset($_SERVER['HTTP_X_FORWARDED_HOST'])) {
        ...
        $wp_siteurl = $protocol . '://' . $_SERVER['HTTP_X_FORWARDED_HOST'] . '';
    } else {
        $wp_home = $protocol . '://' . $host;
        $wp_siteurl = $protocol . '://' . $host . '';
    }
}
...
// Set cookie path to  for WordPress cookies
